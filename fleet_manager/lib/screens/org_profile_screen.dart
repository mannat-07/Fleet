...
class _OrgProfileScreenState extends State<OrgProfileScreen>
  ...
  Widget _buildAvatar(FleetColors c, UserProfile p) {
    final initials = p.avatarInitials.isNotEmpty
        ? p.avatarInitials
        : AppStore.initials(p.name);
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            p.name.isNotEmpty ? p.name : 'Organization',
            style: TextStyle(
              color: c.text,
              fontSize: 20,
              fontWeight: FontWeight.w800,
  ...
  Widget _buildInfoCards(FleetColors c, UserProfile p) {
    final items = [
      ...
      _InfoItem(
        ...
        'Organization',
        p.company.isNotEmpty ? p.company : '—',
      ),
