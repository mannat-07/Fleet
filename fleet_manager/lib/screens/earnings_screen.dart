      ...
      decoration: BoxDecoration(
        gradient: c.isDark
            ? const LinearGradient(
                colors: [Color(0xFF1E1E1E), Color(0xFF2A1A0E)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              )
            : LinearGradient(
                colors: [c.surface, const Color(0xFFFFF3EE)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                _loading
                    ...
                    : Text(
                        _total > 0
                            ? '₹${(_total / 100000).toStringAsFixed(2)}L'
                            : '₹0',
                        style: TextStyle(
                          color: c.text,
                          fontSize: 36,
                ...
                const SizedBox(height: 6),
                Text(
                  '${_tab == 0 ? 'Weekly' : 'Monthly'} • $_recordCount transactions',
                        ...
                        BarChartRodData(
                          ...
                          gradient: LinearGradient(
                            colors: [
                              ...
                              AppColors.orangeEnd.withOpacity(0.6),
                            ],
          ...
          Row(
            children: [
              Expanded(
                child: _StatCard(
                  label: 'Peak Day',
                  value: '₹${(max / 1000).toStringAsFixed(0)}K',
              ...
              Expanded(
                child: _StatCard(
                  label: 'Daily Avg',
                  value: '₹${(avg / 1000).toStringAsFixed(0)}K',
      ...
      child: AnimatedContainer(
        ...
        child: Text(
          ...
          style: TextStyle(
            color: selected
                ? Colors.white
                : FleetTheme.of(context).colors.textSub,
            fontSize: 14,
